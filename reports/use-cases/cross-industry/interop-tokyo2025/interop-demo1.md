...
### 日付から番組情報取得
- ある日時に放送されている放送番組枠を、放送チャンネルや放送時刻を用いて検索する。
- 放送編成枠情報に紐づけられた番組エピソードを特定する。
- 特定した番組エピソードから、番組エピソード名やサムネイル画像URLなどを取得する。
- 取得した番組エピソード名や番組サムネイルを、イベント情報と合わせて一覧表示する。

<figure>
  <img src="/mcm-jp/reports/use-cases/cross-industry/interop-tokyo2025/images/interop1a.png" alt="interop1a" width="800" />
  <figcaption>日付から番組情報取得フロー</figcaption>
</figure>

### 日付から書籍情報取得
<figure>
  <img src="/mcm-jp/reports/use-cases/cross-industry/interop-tokyo2025/images/interop1b.png" alt="interop1b" width="800" />
...
### 位置情報から番組情報取得
<figure>
  <img src="/mcm-jp/reports/use-cases/cross-industry/interop-tokyo2025/images/interop1c.png" alt="interop1c" width="800" />
