...
### Interopミニブース概要[5]
- [展示準備](../../events/interop2025/README.md)
...
- 出版情報 x 放送（小学館）[5]
- [文字入力システム x 出版・放送（オムロンソフトウェア）](../../events/interop2025/demos/20250424_オムロンソフトウェア_interop展示・シナリオ案.pdf)[5]
  - スマホ入力支援
  - メディアコンテンツの正確な情報入力
